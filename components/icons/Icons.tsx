...
// An abstract icon representing knowledge/layers.
export const DrutIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="m12 3-8.25 4.5L12 12l8.25-4.5L12 3Z"/>
        <path d="m4.26 7.5 8.25 4.5 7.25-4"/>
        <path d="m4.26 12 8.25 4.5 7.25-4"/>
    </svg>
);
