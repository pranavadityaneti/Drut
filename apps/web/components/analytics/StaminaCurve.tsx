...
import { StaminaPoint } from '@drut/shared'; // from ../../services/analyticsService';
...
export const StaminaCurve: React.FC<Props> = ({ data }) => {
    if (!data || data.length === 0) {
        return <div className="h-64 flex items-center justify-center text-gray-400 text-sm">Start Your Stamina Journey</div>;
    }
