...
export const ReflectionPanel: React.FC<ReflectionPanelProps> = ({ onReflectionSelect }) => {
 ...
 className="flex flex-col items-start p-4 rounded-lg border-2 border-border hover:border-[var(--color-primary)] hover:bg-accent/50 transition-all duration-200 text-left group"
 >
 <span className="text-base font-medium mb-1 group-hover:text-[#3d7a0f] transition-colors">
 {option.label}
 </span>
