...
const { signup, loginWithGoogle } = authService;
import { User } from '@drut/shared';
import { GoogleIcon } from './icons/Icons';
import { Eye, EyeOff } from 'lucide-react';

/**
 * SignupForm — editorial refresh. Same template as LoginForm; different copy.
 */
    ...
    <div className="w-full">
      <div className="mb-8">
        ...
        <p className="text-[14px] text-[var(--color-ink-3)] mt-3">
          Free to start. Pattern mastery is the difference between rushing and knowing.
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2">
        <button onClick={handleGoogleSubmit} disabled={isGoogleLoading} className={socialCls} aria-label="Continue with Google">
          {isGoogleLoading
